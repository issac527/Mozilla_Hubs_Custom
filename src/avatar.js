        ...
        <div className={classNames([styles.box, styles.darkened])}>
          ...
          <div className={styles.preview}>
            ...
            {copyState ? (
              <div className={styles.copyTip}>
                {copyState === "copying" ? (
                  <FormattedMessage id="avatar-page.copying-avatar" defaultMessage="복사 중..." />
                ) : (
                  <FormattedMessage id="avatar-page.copyied-avatar" defaultMessage="복사" />
                )}
              </div>
            ) : (
              avatar &&
              ...
              avatar.allow_remixing && (
                <a
                  ...
                  title={<FormattedMessage id="avatar-page.copy-button" defaultMessage="아바타 복사" />}
                >
          ...
          {isSelected ? (
            <span className={styles.selectedMessage}>
              <FormattedMessage id="avatar-page.selected" defaultMessage="현재 아바타" />
            </span>
          ) : (
            <button disabled={isSelected} className={styles.formSubmit} type="submit">
              <FormattedMessage id="avatar-page.select" defaultMessage="선택" />
            </button>
          )}
        </div>
        <img
