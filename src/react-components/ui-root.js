...
class UIRoot extends Component {
  ...
  renderInterstitialPrompt = () => {
    return (
      <div className={styles.interstitial} onClick={() => this.props.onInterstitialPromptClicked()}>
        <div>
          <FormattedMessage id="ui-root.interstitial-prompt" defaultMessage="계속" />
        </div>
      </div>
    );
  };
  ...
  render() {
    ...
    const moreMenu = [
      ...
      {
        id: "room",
        label: <FormattedMessage id="more-menu.room" defaultMessage="방" />,
        items: [
          {
            id: "room-info",
            label: <FormattedMessage id="more-menu.room-info" defaultMessage="방 정보 설정 및 변경" />,
            icon: HomeIcon,
          ...
          isModerator &&
            entered && {
              id: "streamer-mode",
              label: streaming ? (
                <FormattedMessage id="more-menu.exit-streamer-mode" defaultMessage="스트리머 모드 종료" />
              ) : (
                <FormattedMessage id="more-menu.enter-streamer-mode" defaultMessage="스트리머 모드 시작" />
              ),
              icon: CameraIcon,
          ...
          (this.props.breakpoint === "sm" || this.props.breakpoint === "md") &&
            entered && {
              id: "leave-room",
              label: <FormattedMessage id="more-menu.enter-leave-room" defaultMessage="나가기" />,
              icon: LeaveIcon,
              onClick: () => {
                this.showNonHistoriedDialog(LeaveRoomModal, {
                  destinationUrl: "/",
      ...
      {
        id: "support",
        label: <FormattedMessage id="more-menu.support" defaultMessage="지원" />,
        items: [
          configs.feature("show_community_link") && {
            id: "community",
            label: <FormattedMessage id="more-menu.community" defaultMessage="커뮤니티" />,
            icon: DiscordIcon,
          ...
          entered && {
            id: "start-tour",
            label: <FormattedMessage id="more-menu.start-tour" defaultMessage="튜토리얼" />,
            icon: SupportIcon,
          ...
          configs.feature("show_whats_new_link") && {
            id: "whats-new",
            label: <FormattedMessage id="more-menu.whats-new" defaultMessage="새 소식" />,
            icon: SupportIcon,
            href: "/whats-new"
          },
          configs.feature("show_terms") && {
            id: "tos",
            label: <FormattedMessage id="more-menu.tos" defaultMessage="서비스 약관" />,
            icon: TextDocumentIcon,
            href: configs.link("terms_of_use", "https://github.com/mozilla/hubs/blob/master/TERMS.md")
          },
          configs.feature("show_privacy") && {
            id: "privacy",
            label: <FormattedMessage id="more-menu.privacy" defaultMessage="개인정보 정책" />,
            icon: ShieldIcon,
                  ...
                  <>
                    {watching && (
                      <>
                        <ToolbarButton
                          icon={<EnterIcon />}
                          label={<FormattedMessage id="toolbar.join-room-button" defaultMessage="입장하기" />}
                          preset="accept"
                        ...
                        {enableSpectateVRButton && (
                          <ToolbarButton
                            icon={<VRIcon />}
                            preset="accent5"
                            label={<FormattedMessage id="toolbar.spectate-in-vr-button" defaultMessage="관전하기" />}
                    ...
                    {entered &&
                      isMobileVR && (
                        <ToolbarButton
                          ...
                          icon={<VRIcon />}
                          preset="accept"
                          label={<FormattedMessage id="toolbar.enter-vr-button" defaultMessage="VR 입장하기" />}
