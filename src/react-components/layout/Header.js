        ...
        <nav>
          <ul>
            ...
            {showDocsLink && (
              <li>
                <a href={docsUrl}>
                  <FormattedMessage id="header.docs" defaultMessage="문서" />
                </a>
              </li>
            )}
            {showSourceLink && (
              <li>
                <a href="https://github.com/mozilla/hubs">
                  <FormattedMessage id="header.source" defaultMessage="Git Hub" />
                </a>
              </li>
            )}
            {showCommunityLink && (
              <li>
                <a href={communityUrl}>
                  <FormattedMessage id="header.community" defaultMessage="커뮤니티" />
                </a>
              </li>
            )}
            {isAdmin && (
              <li>
                <a href="/admin" rel="noreferrer noopener">
                  ...
                  &nbsp;
                  <FormattedMessage id="header.admin" defaultMessage="관리자 설정" />
                </a>
              </li>
            )}
          </ul>
          ...
          {isSignedIn ? (
            <div>
              ...
              <a href="#" onClick={onSignOut}>
                <FormattedMessage id="header.sign-out" defaultMessage="로그아웃" />
              </a>
            </div>
          ) : (
            <a href="/signin" rel="noreferrer noopener">
              <FormattedMessage id="header.sign-in" defaultMessage="로그인" />
            </a>
          )}
        </div>
      </Container>
