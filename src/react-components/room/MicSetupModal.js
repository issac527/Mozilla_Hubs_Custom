...
export function MicSetupModal({
  ...
  return (
    <Modal
      title={<FormattedMessage id="mic-setup-modal.title" defaultMessage="마이크 및 오디오 설정" />}
      ...
      <Column center padding className={styles.content}>
        <p>
          <FormattedMessage
            ...
            defaultMessage="입장하기 전에 마이크와 오디오를 확인하세요."
          />
        </p>
        <div className={styles.audioCheckContainer}>
          <ToolbarButton
            ...
            label={
              microphoneEnabled ? (
                <FormattedMessage id="mic-setup-modal.test-mic" defaultMessage="마이크 테스트" />
              ) : (
                <FormattedMessage id="mic-setup-modal.mic-disabled" defaultMessage="마이크 비활성화" />
              )
            }
          ...
          <ToolbarButton
            ...
            label={<FormattedMessage id="mic-setup-modal.test-audio" defaultMessage="오디오 테스트" />}
        ...
        <>
          ...
          <ToggleInput
            label={<FormattedMessage id="mic-setup-modal.mute-mic-toggle" defaultMessage="마이크 음소거" />}
            checked={microphoneMuted}
            onChange={onChangeMicrophoneMuted}
          />
        </>
        <Button preset="accept" onClick={onEnterRoom}>
          <FormattedMessage id="mic-setup-modal.enter-room-button" defaultMessage="입장하기" />
        </Button>
      </Column>
    </Modal>
  );
