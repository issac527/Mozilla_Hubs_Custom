...
export const AllButtons = args => (
  <Column padding>
    ...
    <ToolbarButton icon={<ShareIcon />} label="화면 공유" preset="accent5" statusColor="recording" />
    <ToolbarButton icon={<MicrophoneIcon />} label="음성" statusColor="enabled" />
  </Column>
);
  ...
  <RoomLayout
    ...
    toolbarCenter={
      <>
        ...
        <ToolbarButton icon={<ShareIcon />} label="화면 공유" preset="accent5" />
        <ToolbarButton icon={<ObjectIcon />} label="기능" preset="accent3" />
        <ToolbarButton icon={<ReactionIcon />} label="반응" preset="accent2" />
        <ToolbarButton icon={<ChatIcon />} label="대화" preset="accent4" />
      </>
    }
    toolbarRight={
      <>
